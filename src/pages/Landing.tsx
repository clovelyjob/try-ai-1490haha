      ...
      <section className="container mx-auto px-4 py-20 md:py-32 max-w-7xl">
        ...
        duration: 0.6
          ...
          duration: 0.6
            ...
            <img src={heroImage} alt="Profesional joven trabajando con confianza en su desarrollo de carrera" className="w-full max-w-full h-auto object-cover" />
          </motion.div>
        </motion.div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                delay: 0.2
                  ...
                  <img src={collaborationImage} alt="Equipo colaborando en desarrollo profesional" className="w-full max-w-full h-auto object-cover" />
                </motion.div>
              </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              ...
              delay: i * 0.1
                  ...
                  {i < steps.length - 1 && <div className="hidden md:block absolute top-1/2 -right-3 z-10 -translate-y-1/2">
            ...
            delay: 0.4
              ...
              <img src={careerDiscoveryImage} alt="Momento de descubrimiento profesional con análisis de carrera" className="w-full max-w-full h-auto object-cover" />
            </motion.div>
          </div>
        </motion.div>
      </section>
