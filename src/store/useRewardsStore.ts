...
const MOCK_REWARDS: Reward[] = [
  ...
  {
    id: 'rew_2',
    title: 'Acceso Anticipado a Recursos',
    description: 'Sé el primero en acceder a nuevas funcionalidades',
    cost: 150,
    icon: 'Gift',
    category: 'gift_card',
    available: true,
  ...
  {
    id: 'rew_5',
    title: 'Insignia de Logro Exclusiva',
    description: 'Destaca en la comunidad con una insignia única',
    cost: 250,
    icon: 'Gift',
    category: 'gift_card',
    available: true,
  ...
  {
    id: 'rew_8',
    title: 'Participación en Reto Semanal',
    description: 'Únete a retos exclusivos con la comunidad',
    cost: 100,
    icon: 'Gift',
    category: 'gift_card',
    available: true,
  },
  {
    ...
    description: 'Análisis profundo de tu perfil profesional',
    cost: 300,
    icon: 'MessageCircle',
    category: 'mentorship',
    available: true,
  ...
  {
    id: 'rew_10',
    title: 'Créditos de Aprendizaje',
    description: 'Acceso a cursos y recursos educativos premium',
    cost: 200,
    icon: 'BookOpen',
    category: 'course',
    available: true,
